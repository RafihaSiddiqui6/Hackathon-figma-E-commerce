    ...
    <div>
      <section>
        <div className='py-12 bg-[#F9F9F9] text-[#2A254B] mt-12'>
          <div className='w-full max-w-[640px] md:max-w-[1273px] h-[364px] bg-white mx-auto flex justify-center items-center flex-col px-4'>
            ...
            <div className='mt-4 w-full'>
              <form action="" className='flex flex-col md:flex-row items-center justify-center'>
                ...
                />
                <button className='p-2 bg-[#2A254B] text-white w-full md:w-[118px] h-[56px] hover:bg-[#6e65a8]'>
                  Signup
                </button>
              </form>
            </div>
